...
#define BLYNK_TEMPLATE_ID "TMPL28jcsW1S_"
#define BLYNK_TEMPLATE_NAME "Test mppt"
...
auth[] = "VdpDShciZygJjIdI6SWADYRoVS3KP7es",   //   USER PARAMETER - Input Blynk Authentication Token (From email after registration)
ssid[] = "Good Machine",                   //   USER PARAMETER - Enter Your WiFi SSID
pass[] = "1500trains";               //   USER PARAMETER - Enter Your WiFi Password
...
enableWiFi              = 0,           //   USER PARAMETER - Enable WiFi Connection
enableFan               = 0,           //   USER PARAMETER - Enable Cooling Fan
enableBluetooth         = 0,           //   USER PARAMETER - Enable Bluetooth Connection
